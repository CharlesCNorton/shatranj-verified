...
**6.8** Except where Articles 5.1, 5.2, 5.3, or 5.4 apply, if a player does not complete the prescribed number of moves in the allotted time, the game is lost by that player.
